-- CreateEnum
CREATE TYPE "UserType" AS ENUM ('school_user', 'admin_user');

-- CreateEnum
CREATE TYPE "Role" AS ENUM ('school_director', 'principal', 'teacher', 'hr', 'finance', 'parent', 'super_admin', 'sales_marketing', 'support_hr', 'admin_finance', 'engineer');
